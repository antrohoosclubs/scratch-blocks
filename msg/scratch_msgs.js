...
ScratchMsgs.locales['hyw'] = {
  CONTROL_FOREVER: 'անսահման',
  CONTROL_REPEAT: 'կրկնել %1',
  CONTROL_IF: 'եթե %1 ըլլայ, ապա',
  CONTROL_ELSE: 'հակառակ պարագային',
  CONTROL_STOP: 'կանգնեցնել',
  CONTROL_STOP_ALL: 'ամենը',
  CONTROL_STOP_THIS: 'սյս սցենարը',
  CONTROL_STOP_OTHER: 'կերպարին մէջ գտնուող միւս սցենարները',
  CONTROL_WAIT: 'սպասել  %1երկվայրկեան',
  CONTROL_WAITUNTIL: 'սպասել մինչեւ  %1',
  CONTROL_REPEATUNTIL: 'կրկնել մինչեւ  %1',
  CONTROL_WHILE: 'մինչ  %1',
  CONTROL_FOREACH: 'իւրաքանչիւրին համար %1 ֊ից %2',
  CONTROL_STARTASCLONE: 'Երբ կը սկսիմ որպէս կրկնօրինակ մը',
  CONTROL_CREATECLONEOF: 'ստեղծել %1 կրկնօրինակ մը',
  CONTROL_CREATECLONEOF_MYSELF: 'ինձմէ',
  CONTROL_DELETETHISCLONE: 'ջնջել այս կրկնօրինակը',
  CONTROL_COUNTER: 'հաշուիչ',
  CONTROL_INCRCOUNTER: 'մեծցնել հաշուիչը',
  CONTROL_CLEARCOUNTER: 'մաքրել հաշուիչը',
  CONTROL_ALLATONCE: 'բոլորը միասին',
  DATA_SETVARIABLETO: '%1‑ը՝ %2',
  DATA_CHANGEVARIABLEBY: 'Փոխել %1‑ը %2‑ով',
  DATA_SHOWVARIABLE: 'Ցոյց տալ %1 փոփոխականը',
  DATA_HIDEVARIABLE: 'ծածկել փոփոխականը %1',
  DATA_ADDTOLIST: 'աւելցնել %1֊ը %2-ին',
  DATA_DELETEOFLIST: 'ջնջել %1-ը %2-էն',
  DATA_DELETEALLOFLIST: 'ջնջել %1-էն ամբողջ',
  DATA_INSERTATLIST: '%3 -ի %2 -ին մէջ զետեղել %1 -ը',
  DATA_REPLACEITEMOFLIST: 'փոխարինել %1 տարրը %2-ից %3-ով',
  DATA_ITEMOFLIST: '%2-ի %1 տարրը',
  DATA_ITEMNUMOFLIST: '%1-ին տարրի #-ը %2-ի մէջ',
  DATA_LENGTHOFLIST: '%1-ի երկարութիւնը',
  DATA_LISTCONTAINSITEM: '%1-ը կը պարունակէ՞ %2',
  DATA_SHOWLIST: 'ցոյց տալ %1-ը ցուցակը',
  DATA_HIDELIST: 'ծածկել ցուցակը %1',
  DATA_INDEX_ALL: 'բոլորը',
  DATA_INDEX_LAST: 'վերջինը',
  DATA_INDEX_RANDOM: 'պատահական',
  EVENT_WHENFLAGCLICKED: 'երբ %1‑ը սեղմուած է',
  EVENT_WHENTHISSPRITECLICKED: 'երբ այս կերպարը սեղմուած է',
  EVENT_WHENSTAGECLICKED: 'երբ բեմը սեղմուած է',
  EVENT_WHENTOUCHINGOBJECT: 'երբ այս կերպարը կը դպչի %1',
  EVENT_WHENBROADCASTRECEIVED: 'երբ կը ստանամ %1',
  EVENT_WHENBACKDROPSWITCHESTO: 'երբ յետնապատկերը կը փոխարինուի %1-ով',
  EVENT_WHENGREATERTHAN: 'երբ %1-ը մեծ է %2-ից ',
  EVENT_WHENGREATERTHAN_TIMER: 'ժամաչափ',
  EVENT_WHENGREATERTHAN_LOUDNESS: 'ձայնի բարձրութիւնը',
  EVENT_BROADCAST: 'հաղորդագրութիւն %1',
  EVENT_BROADCASTANDWAIT: 'հաղորդագրէ %1 եւ սպասէ',
  EVENT_WHENKEYPRESSED: 'երբ %1 ստեղնը սեղմուած է',
  EVENT_WHENKEYPRESSED_SPACE: 'միջոց',
  EVENT_WHENKEYPRESSED_LEFT: 'ձախ սլաք',
  EVENT_WHENKEYPRESSED_RIGHT: 'աջ սլաք',
  EVENT_WHENKEYPRESSED_DOWN: 'վար սլաք',
  EVENT_WHENKEYPRESSED_UP: 'վեր սլաք',
  EVENT_WHENKEYPRESSED_ANY: 'որեւէ',
  LOOKS_SAYFORSECS: 'ըսել %1 %2 երկվայրկեան',
  LOOKS_SAY: 'ըսել %1',
  LOOKS_HELLO: 'Բարեւ',
  LOOKS_THINKFORSECS: 'մտածել %1 %2 երկվայրկեան',
  LOOKS_THINK: 'մտածել %1',
  LOOKS_HMM: 'Հմմմ․․․',
  LOOKS_SHOW: 'ցոյց տալ',
  LOOKS_HIDE: 'ծածկել',
  LOOKS_HIDEALLSPRITES: 'ծածկել բոլոր կերպարները',
  LOOKS_EFFECT_COLOR: 'գոյն',
  LOOKS_EFFECT_FISHEYE: 'ձուկի աչք',
  LOOKS_EFFECT_WHIRL: 'մրրիկ',
  LOOKS_EFFECT_PIXELATE: 'փիքսելցնել',
  LOOKS_EFFECT_MOSAIC: 'խճանկար',
  LOOKS_EFFECT_BRIGHTNESS: 'պայծառութիւն',
  LOOKS_EFFECT_GHOST: 'ուրուական',
  LOOKS_CHANGEEFFECTBY: 'փոխել %1 տեսողական ազդեցութիւնը %2֊ով',
  LOOKS_SETEFFECTTO: 'կիրառել %1 ազդեցութիւնը %2 արժեքով',
  LOOKS_CLEARGRAPHICEFFECTS: 'մաքրել գծանկարչական ազդեցութիւնը',
  LOOKS_CHANGESIZEBY: 'փոխել չափը %1-ով',
  LOOKS_SETSIZETO: 'չափը՝ %1 %',
  LOOKS_SIZE: 'չափը',
  LOOKS_CHANGESTRETCHBY: 'փոխել երկայնքը %1-ով',
  LOOKS_SETSTRETCHTO: 'երկայնքը ՝ %1  %',
  LOOKS_SWITCHCOSTUMETO: 'փոխել զգեստը %1-ի',
  LOOKS_NEXTCOSTUME: 'յաջորդ զգեստը',
  LOOKS_SWITCHBACKDROPTO: 'յետնապատկերը՝ %1',
  LOOKS_GOTOFRONTBACK: 'երթալ դէպի %1 շերտ',
  LOOKS_GOTOFRONTBACK_FRONT: 'դիմաց',
  LOOKS_GOTOFRONTBACK_BACK: 'ետեւ',
  LOOKS_GOFORWARDBACKWARDLAYERS: 'երթալ %1 %2 շերտեր',
  LOOKS_GOFORWARDBACKWARDLAYERS_FORWARD: 'առաջ',
  LOOKS_GOFORWARDBACKWARDLAYERS_BACKWARD: 'ետ',
  LOOKS_BACKDROPNUMBERNAME: 'յետնապատկեր %1',
  LOOKS_COSTUMENUMBERNAME: 'զգեստ %1',
  LOOKS_NUMBERNAME_NUMBER: 'թիւ',
  LOOKS_NUMBERNAME_NAME: 'անուն',
  LOOKS_SWITCHBACKDROPTOANDWAIT: 'յետնապատկերը փոխարինել %1-ով եւ սպասել',
  LOOKS_NEXTBACKDROP_BLOCK: 'յաջորդ յետնապատկերը',
  LOOKS_NEXTBACKDROP: 'յաջորդ յետնապատկերը',
  LOOKS_PREVIOUSBACKDROP: 'նախորդ յետնապատկերը',
  LOOKS_RANDOMBACKDROP: 'պատահական յետնապատկեր',
  MOTION_MOVESTEPS: 'տեղափոխուիլ %1 քայլ',
  MOTION_TURNLEFT: 'դառնալ %1 %2 աստիճան',
  MOTION_TURNRIGHT: 'աջ դառնալ %1 %2 աստիճան',
  MOTION_POINTINDIRECTION: 'ուղղել %1 ուղղութեամբ',
  MOTION_POINTTOWARDS: 'ուղղուիլ դէպի %1',
  MOTION_POINTTOWARDS_POINTER: 'մկնիկի ցուցիչ',
  MOTION_POINTTOWARDS_RANDOM: 'պատահական ուղղութիւն',
  MOTION_GOTO: 'երթալ դէպի %1',
  MOTION_GOTO_POINTER: 'մկնիկի ցուցիչ',
  MOTION_GOTO_RANDOM: 'պատահական դիրք',
  MOTION_GOTOXY: 'երթալ դէպի x՝ %1 y՝ %2',
  MOTION_GLIDESECSTOXY: 'սահիլ  %1 երկվայրկեան դէպի x՝ %2 y` %3',
  MOTION_GLIDETO: 'սահիլ  %1 երկվայրկեան դէպի %2',
  MOTION_GLIDETO_POINTER: 'մկնիկի ցուցիչ',
  MOTION_GLIDETO_RANDOM: 'պատահական դիրք',
  MOTION_CHANGEXBY: 'փոխել x-ը %1 -ով',
  MOTION_SETX: 'x` %1',
  MOTION_CHANGEYBY: 'փոխել y-ը %1-ով',
  MOTION_SETY: 'y՝ %1',
  MOTION_IFONEDGEBOUNCE: 'եթէ եզրին է, հրուիլ',
  MOTION_SETROTATIONSTYLE: 'պտոյտի ձեւը՝ %1',
  MOTION_SETROTATIONSTYLE_LEFTRIGHT: 'ձախ-աջ',
  MOTION_SETROTATIONSTYLE_DONTROTATE: 'չդառնալ',
  MOTION_SETROTATIONSTYLE_ALLAROUND: 'շուրջ բոլորը',
  MOTION_XPOSITION: 'x-ը',
  MOTION_YPOSITION: 'Y-ը',
  MOTION_DIRECTION: 'ուղղութիւն',
  MOTION_SCROLLRIGHT: 'գլորել աջ %1',
  MOTION_SCROLLUP: 'գլորել վեր %1',
  MOTION_ALIGNSCENE: 'ուղղել տեսարանը %1',
  MOTION_ALIGNSCENE_BOTTOMLEFT: 'վար-ձախ',
  MOTION_ALIGNSCENE_BOTTOMRIGHT: 'վար-աջ',
  MOTION_ALIGNSCENE_MIDDLE: 'մէջտեղ',
  MOTION_ALIGNSCENE_TOPLEFT: 'վեր-ձախ',
  MOTION_ALIGNSCENE_TOPRIGHT: 'վեր-աջ',
  MOTION_XSCROLL: 'x-ը գլորել',
  MOTION_YSCROLL: 'y-ը գլորել',
  MOTION_STAGE_SELECTED: 'Բեմն ընտրուած է` շարժի մասնիկներ չկան',
  OPERATORS_ADD: '%1 + %2',
  OPERATORS_SUBTRACT: '%1 - %2',
  OPERATORS_MULTIPLY: '%1 * %2',
  OPERATORS_DIVIDE: '%1 / %2',
  OPERATORS_RANDOM: 'պատահական թիւ %1-էն %2-ը',
  OPERATORS_GT: '%1 > %2',
  OPERATORS_LT: '%1 < %2',
  OPERATORS_EQUALS: '%1 = %2',
  OPERATORS_AND: '%1 եւ %2',
  OPERATORS_OR: '%1 կամ %2',
  OPERATORS_NOT: 'ոչ %1-ին',
  OPERATORS_JOIN: 'միաւորել %1 %2',
  OPERATORS_JOIN_APPLE: 'խնձոր',
  OPERATORS_JOIN_BANANA: 'պանան',
  OPERATORS_LETTEROF: '%2-ի %1-րդ տառը',
  OPERATORS_LETTEROF_APPLE: 'խ',
  OPERATORS_LENGTH: '%1 տողի երկարութիւնը',
  OPERATORS_CONTAINS: '%1-ը կը պարունակէ՞ %2',
  OPERATORS_MOD: '%1 մնացորդ %2',
  OPERATORS_ROUND: 'կլորցնել %1-ը',
  OPERATORS_MATHOP: '%1 -էն %2',
  OPERATORS_MATHOP_ABS: 'բացարձակ արժէք (abs)',
  OPERATORS_MATHOP_FLOOR: 'ամբողջ թիւ՝ վար',
  OPERATORS_MATHOP_CEILING: 'ամբողջ թիւ՝ վեր',
  OPERATORS_MATHOP_SQRT: 'արմատ',
  OPERATORS_MATHOP_SIN: 'sin',
  OPERATORS_MATHOP_COS: 'cos',
  OPERATORS_MATHOP_TAN: 'tan',
  ...
  OPERATORS_MATHOP_10EXP: '10^',
  PROCEDURES_DEFINITION: 'սահմանել %1',
  SENSING_TOUCHINGOBJECT: 'կը դպչի՞ %1',
  SENSING_TOUCHINGOBJECT_POINTER: 'մկնիկի ցուցիչ',
  SENSING_TOUCHINGOBJECT_EDGE: 'եզր',
  SENSING_TOUCHINGCOLOR: 'կը դպչի՞ %1 գոյնին',
  SENSING_COLORISTOUCHINGCOLOR: '%1 գոյնը կը դպչի՞ %2',
  SENSING_DISTANCETO: 'հեռաւորութիւնը %1-էն',
  SENSING_DISTANCETO_POINTER: 'մկնիկի ցուցիչ',
  SENSING_ASKANDWAIT: 'հարցնել %1 եւ սպասել',
  SENSING_ASK_TEXT: 'Ի՞նչ է անունդ։',
  SENSING_ANSWER: 'պատասխան',
  SENSING_KEYPRESSED: 'ստեղնը %1֊ը սեղմուա՞ծ է',
  SENSING_MOUSEDOWN: 'մկնիկը սեղմուա՞ծ է',
  SENSING_MOUSEX: 'մկնիկ x -ը',
  SENSING_MOUSEY: 'մկնիկ y -ը',
  SENSING_SETDRAGMODE: 'տեղափոխման եղանակը %1',
  SENSING_SETDRAGMODE_DRAGGABLE: 'սահուն',
  SENSING_SETDRAGMODE_NOTDRAGGABLE: 'ընդհատ',
  SENSING_LOUDNESS: 'ձայնի բարձրութիւնը',
  SENSING_LOUD: 'ձայնը բա՞րձր է',
  SENSING_TIMER: 'ժամաչափ',
  SENSING_RESETTIMER: 'ժամաչափը զերոյի վերածել',
  SENSING_OF: '%2 -ի %1-ը',
  SENSING_OF_XPOSITION: 'x -ը',
  SENSING_OF_YPOSITION: 'y -ը',
  SENSING_OF_DIRECTION: 'ուղղութիւն',
  SENSING_OF_COSTUMENUMBER: 'զգեստ #',
  SENSING_OF_COSTUMENAME: 'զգեստի անունը',
  SENSING_OF_SIZE: 'չափ',
  SENSING_OF_VOLUME: 'ձայնի բարձրութիւն',
  SENSING_OF_BACKDROPNUMBER: 'յետնապատկեր #',
  SENSING_OF_BACKDROPNAME: 'յետնապատկերի անունը',
  SENSING_OF_STAGE: 'Բեմ',
  SENSING_CURRENT: 'ընթացիկ %1',
  SENSING_CURRENT_YEAR: 'տարի',
  SENSING_CURRENT_MONTH: 'ամիս',
  SENSING_CURRENT_DATE: 'թուական',
  SENSING_CURRENT_DAYOFWEEK: 'շաբթուան օր',
  SENSING_CURRENT_HOUR: 'ժամ',
  SENSING_CURRENT_MINUTE: 'վայրկեան',
  SENSING_CURRENT_SECOND: 'երկվայրկեան',
  SENSING_DAYSSINCE2000: 'օրերը՝  2000-էն սկսեալ',
  SENSING_ONLINE: 'առցա՞նց է',
  SENSING_USERNAME: 'օգտատիրոջ անուն',
  SENSING_USERID: 'օգտատիրոջ id',
  SOUND_PLAY: 'սկսիլ %1 ձայնը',
  SOUND_PLAYUNTILDONE: 'Արտաբերել ձայնը %1֊ը մինչեւ աւարտը',
  SOUND_STOPALLSOUNDS: 'կեցնել բոլոր ձայները',
  SOUND_SETEFFECTO: 'կիրարկել %1 ձայնային ազդեցութիւնը %2 արժէքով',
  SOUND_CHANGEEFFECTBY: 'փոխել %1 ազդեցութիւնը %2‑ով',
  SOUND_CLEAREFFECTS: 'մաքրել ձայնային ազդեցութիւնները',
  SOUND_EFFECTS_PITCH: 'խօսք',
  SOUND_EFFECTS_PAN: 'տարածում ձախ/աջ',
  SOUND_CHANGEVOLUMEBY: 'փոխել ձայնի բարձրութիւնը %1‑ով',
  SOUND_SETVOLUMETO: 'ձայնի բարձրութիւնը՝ %1%',
  SOUND_VOLUME: 'ձայնի բարձրութիւնը',
  SOUND_RECORD: 'Ձայնագրել…',
  CATEGORY_MOTION: 'Շարժում',
  CATEGORY_LOOKS: 'Տեսք',
  CATEGORY_SOUND: 'Ձայն',
  CATEGORY_EVENTS: 'Դէպքեր',
  CATEGORY_CONTROL: 'Կառավարում',
  CATEGORY_SENSING: 'Զգայութիւն',
  CATEGORY_OPERATORS: 'Հաշուարկ',
  CATEGORY_VARIABLES: 'Փոփոխական',
  CATEGORY_MYBLOCKS: 'Մասնիկ',
  DUPLICATE: 'Կրկնօրինակել',
  DELETE: 'Ջնջել',
  ADD_COMMENT: 'Աւելցնել մեկնաբանութիւն',
  REMOVE_COMMENT: 'Հեռացնել',
  DELETE_BLOCK: 'Մեկնաբանութիւն',
  DELETE_X_BLOCKS: 'Ջնջել %1 մասնիկները',
  DELETE_ALL_BLOCKS: 'Ջնջե՞լ բոլոր %1 մասնիկները։',
  CLEAN_UP: 'Մաքրել մասնիկները',
  HELP: 'Օգնութիւն',
  ...
  REDO: 'Յառաջ երթալ',
  EDIT_PROCEDURE: 'Խմբագրել',
  SHOW_PROCEDURE_DEFINITION: 'Երթալ սահմանումը',
  WORKSPACE_COMMENT_DEFAULT_TEXT: 'Բան մը ըսէ...',
  COLOUR_HUE_LABEL: 'Գոյն',
  COLOUR_SATURATION_LABEL: 'Յագեցուածութիւն',
  COLOUR_BRIGHTNESS_LABEL: 'Պայծառութիւն',
  CHANGE_VALUE_TITLE: 'Փոխել արժէքը՝',
  RENAME_VARIABLE: 'Անուանափոխել փոփոխականը',
  RENAME_VARIABLE_TITLE: 'Անուանափոխել  բոլոր «%1» փոփոխականները՝',
  RENAME_VARIABLE_MODAL_TITLE: 'Անուանափոխել փոփոխականը',
  NEW_VARIABLE: 'Ստեղծել փոփոխական',
  NEW_VARIABLE_TITLE: 'Նոր փոփոխականի անունը՝',
  VARIABLE_MODAL_TITLE: 'Նոր փոփոխական',
  VARIABLE_ALREADY_EXISTS: '«%1» անունով փոփոխական  արդէն գոյութիւն ունի։',
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE: '«%1» անունով փոփոխականը արդէն առկայ է «%2» տիպին մէջ։',
  DELETE_VARIABLE_CONFIRMATION: 'Ջնջե՞լ «%2» փոփոխականի %1 կիրարկումը։',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Կարելի չէ ջնջել «%1» փոփոխականը, քանի որ անիկա «%2» գործառոյթի սահմանման մէկ մասն է։',
  DELETE_VARIABLE: 'Ջնջել «%1» փոփոխականը',
  NEW_PROCEDURE: 'Ստեղծել մասնիկ',
  PROCEDURE_ALREADY_EXISTS: '«%1» անունով գործողութիւն արդէն գոյութիւն ունի։',
  PROCEDURE_DEFAULT_NAME: 'մասնիկի անունը',
  PROCEDURE_USED: 'Մասնիկը ջնջելու համար, նախ պէտք է ջնջել անոր բոլոր կիրարկումները։',
  NEW_LIST: 'Ստեղծել ցուցակ',
  NEW_LIST_TITLE: 'Նոր ցուցակի անունը՝',
  LIST_MODAL_TITLE: 'Նոր ցուցակ',
  LIST_ALREADY_EXISTS: '«%1» անունով ցուցակ արդէն գոյութիւն ունի։ ',
  RENAME_LIST_TITLE: 'Անուանափոխել ամբողջ «%1» ցուցակը՝',
  RENAME_LIST_MODAL_TITLE: 'Անուանափոխել ցուցակը',
  DEFAULT_LIST_ITEM: 'առարկայ',
  DELETE_LIST: 'Ջնջել «%1» ցուցակը',
  RENAME_LIST: 'Անուանափոխել ցուցակը',
  NEW_BROADCAST_MESSAGE: 'Նոր հաղորդագրութիւն',
  NEW_BROADCAST_MESSAGE_TITLE: 'Նոր հաղորդագրութեան անունը՝',
  BROADCAST_MODAL_TITLE: 'Նոր հաղորդագրութիւն',
  DEFAULT_BROADCAST_MESSAGE_NAME: 'հաղորդագրութիւն1',
}
